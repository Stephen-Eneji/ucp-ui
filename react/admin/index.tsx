...
ReactRender(({ ...props }) => {
  const helpfulLinks = [
    {
      name: "Documentation",
      link: props?.PluginURI ?? "https://ultimatecryptowidget.com",
    },
    {
      name: "Support",
        ...
        <div className={`ucwp-admin-welcome`}>
          ...
          <div className={`ucwp-admin-welcome-message`}>
            <p>
              {" "}
              {__(
                "Welcome to the Ultimate Crypto Widget plugin.",
            ...
            <p>
              {" "}
              {__(
                "This plugin allows you to display the current price of any cryptocurrency in your website.",
                "ultimate-crypto-widget"
              )}{" "}
            </p>
            helpful links
