...
const Card001 = ({
  ...
  websocketData ?: any;
	...
	console.log(websocketData, "card")
    ...
    <div {...props}>
      ...
      <div className="ucwp-coin-marquee-main-coin-basic-info">
        <div className="ucwp-coin-marquee-coin-name-and-symbol">
          ...
          <span className="ucwp-coin-marquee-coin-symbol">
            ({coin.symbol.toUpperCase()})
          </span>
        </div>
        <div className="ucwp-coin-marquee-coin-price">
          <span className="ucwp-coin-marquee-coin-price-text">
            {currency_symbol}
            {websocketData?.lastPrice ?? coin.current_price}
          </span>
        </div>
        <div className="wcp-coin-marquee-coin-growth">
          ...
          ></i>
          <span className="ucwp-coin-marquee-coin-growth-text">
